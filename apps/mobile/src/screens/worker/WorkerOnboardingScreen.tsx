...
export const WorkerOnboardingScreen=({onComplete}:Props):React.JSX.Element=>{
 ...
 return <Screen padded={false}><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
  ...
  <AppCard><AppText variant="title">Before KYC</AppText><AppText variant="body" muted style={styles.next}>A profile photo and worker location are still required before KYC submission. Location and media capture will be connected through the native worker flow.</AppText></AppCard>
